...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.019; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.0172 / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = Math.toRadians(179.57673818609064);
